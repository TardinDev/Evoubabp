        ...
        <section id="projects" className="px-4 sm:px-6 pt-3 pb-6" style={{ backgroundColor: '#d4e4fa' }}>
          <motion.div variants={fadeIn("up", "tween", 0.1, 1)}>
            <div className="mb-8 last:mb-0">
              <h2 className="text-2xl font-bold mb-3 text-gray-800">Applications Mobiles</h2>
              <p className="text-gray-500 mb-5 text-sm">Quelques applications mobiles que j&apos;ai développées.</p>
          ...
          <motion.div variants={fadeIn("up", "tween", 0.3, 1)}>
            <div className="mb-8 last:mb-0">
              <h2 className="text-2xl font-bold mb-3 text-gray-800">Applications Web</h2>
              <p className="text-gray-500 mb-5 text-sm">Des applications web que j&apos;ai développées pour mes clients.</p>
